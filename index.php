...
<title>Home | BlueSky Airlines</title>
<link rel="icon" href="img/icon2.PNG"><!--ICONNNR-->
...
<script>
	...
	var today = new Date();
	 ...
	 $(function(){
	        $("#return_date").datepicker({ dateFormat: 'yy-mm-dd', minDate: 0, maxDate: '2024-06-30', showButtonPanel: true, changeMonth: true, changeYear: true, showAnim: "slideDown" });
	        $("#depart_date").datepicker({ dateFormat: 'yy-mm-dd', minDate: 0, maxDate: '2024-06-30', showButtonPanel: true, changeMonth: true, changeYear: true, showAnim: "slideDown" }).bind("change",function(){
...
<div id="menubar-id">
        ...
        <a href="index.php"><img id="menu_logo" src="img/logo1.png"/></a>  <!--ICONNNR-->
            <ul  class="mb">
...
<div class="footer">
  <p>copyright ,Essya Doghri & Hanine Ben Farhat </p>
</div>
<script>
